...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $every = "UPDATE `class` SET `sched2`='$sched'";
                            ...
                            <div class="container mt-5">
                                <div class="row">
                                    <div class="col-8 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" type="text" placeholder="<?php echo $class['sched2']; ?>" aria-label=".form-control-lg example" name="sched">
                                    </div>
                                    <div class="mb-3">
